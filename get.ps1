#Script Source Address: https://raw.githubusercontent.com/filebrowser/get/master/get.ps1
...
function Install-FileManager {
	...
	$arch = "386"
	$osarch = (Get-WmiObject Win32_OperatingSystem).OSArchitecture -eq "64-bit"
